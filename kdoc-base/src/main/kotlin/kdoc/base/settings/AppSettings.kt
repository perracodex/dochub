...
package kdoc.base.settings

import io.ktor.server.config.*
import kdoc.base.env.Tracer
import kdoc.base.settings.annotation.ConfigurationAPI
import kdoc.base.settings.config.ConfigurationCatalog
import kdoc.base.settings.config.parser.ConfigClassMap
import kdoc.base.settings.config.parser.ConfigurationParser
import kdoc.base.settings.config.parser.IConfigSection
import kdoc.base.settings.config.sections.*
...
object AppSettings {
    ...
    /** The application storage settings. */
    val storage: StorageSettings get() = configuration.storage
    ...
    fun load(applicationConfig: ApplicationConfig) {
        ...
        val timeTaken = measureTimeMillis {
            ...
            val configMappings: List<ConfigClassMap<out IConfigSection>> = listOf(
                ...
                ConfigClassMap(mappingName = "storage", path = "storage", kClass = StorageSettings::class)
            )
