...
/**
 * Composite exception to aggregate multiple [dochub.base.error.AppException] instances
 ...
 *
 * @property errors A list of [dochub.base.error.AppException] instances, each representing an individual error.
 */
