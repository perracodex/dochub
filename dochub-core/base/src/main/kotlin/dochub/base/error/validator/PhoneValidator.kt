...
package dochub.base.error.validator

import com.google.i18n.phonenumbers.NumberParseException
import com.google.i18n.phonenumbers.PhoneNumberUtil
import dochub.base.env.Tracer
import dochub.base.error.validator.base.IValidator
import dochub.base.error.validator.base.ValidationException
                ...
                is ValidationException -> {
                    ...
                    return@getOrElse Result.failure(
                        ValidationException(
                            ...
                            message = error.message ?: "Error validating phone number: $value"
                        )
                    )
                }
            }
