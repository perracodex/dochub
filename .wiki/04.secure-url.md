...
[Secure URLs](../kdochub-core/base/src/main/kotlin/kdochub/base/security/util/SecureUrl.kt) are used to provide encrypted URLs helping to obscure actual resources,
