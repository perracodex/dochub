...
2. **Parameter Parsing**:
   ...
   - Note all document types must be defined in the [DocumentType](../dochub-core/database/src/main/kotlin/dochub/database/schema/document/type/DocumentType.kt) enum:
