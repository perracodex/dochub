...
2. **Parameter Parsing**:
   ...
   - Note all document types must be defined in the [DocumentType](../kdochub-system/database/src/main/kotlin/kdochub/database/schema/document/type/DocumentType.kt) enum:
