...
package kdochub.access.domain.token.api

import io.ktor.server.routing.*
import kdochub.access.domain.token.annotation.TokenApi
import kdochub.access.domain.token.api.operate.createTokenRoute
import kdochub.access.domain.token.api.operate.refreshTokenRoute
