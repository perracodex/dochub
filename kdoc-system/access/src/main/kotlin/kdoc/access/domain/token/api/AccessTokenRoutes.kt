...
package kdoc.access.domain.token.api

import io.ktor.server.routing.*
import kdoc.access.domain.token.annotation.TokenApi
import kdoc.access.domain.token.api.operate.createTokenRoute
import kdoc.access.domain.token.api.operate.refreshTokenRoute
