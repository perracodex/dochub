...
LABEL image.tag="dochub-build"
LABEL name="dochub-build-image"
...
LABEL authors="perracodex"
LABEL image.tag="dochub"
LABEL name="dochub-final-image"
...
COPY --from=build /home/gradle/src/build/libs/dochub-1.0.0-all.jar /app/dochub-1.0.0-all.jar
...
ENV DOCHUB_KTOR_DEPLOYMENT_HOST="0.0.0.0"

# Set the SSL key location.
ENV DOCHUB_KTOR_SECURITY_SSL_KEY_STORE="/app/keystore.p12"
...
ENV JAVA_OPTS=""
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTS -jar /app/dochub-1.0.0-all.jar"]
