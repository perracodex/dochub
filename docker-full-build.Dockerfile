...
LABEL image.tag="kdochub-build"
LABEL name="kdochub-build-image"
...
LABEL authors="perracodex"
LABEL image.tag="kdochub"
LABEL name="kdochub-final-image"
...
COPY --from=build /home/gradle/src/build/libs/kdochub-1.0.0-all.jar /app/kdochub-1.0.0-all.jar
...
ENV KDOCHUB_KTOR_DEPLOYMENT_HOST="0.0.0.0"

# Set the SSL key location.
ENV KDOCHUB_KTOR_SECURITY_SSL_KEY_STORE="/app/keystore.p12"
...
ENV JAVA_OPTS=""
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTS -jar /app/kdochub-1.0.0-all.jar"]
