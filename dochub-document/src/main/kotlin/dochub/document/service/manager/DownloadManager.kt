...
package dochub.document.service.manager

import dochub.base.env.Telemetry
import dochub.base.env.Tracer
import dochub.base.security.util.SecureIO
import dochub.base.util.DateTimeUtils
import dochub.base.util.DateTimeUtils.current
import dochub.base.util.DateTimeUtils.format
...
internal object DownloadManager {
    ...
    val downloadCountMetric: Counter = Telemetry.registerCounter(
        name = "dochub_document_downloads_total",
    ...
    val backupCountMetric: Counter = Telemetry.registerCounter(
        name = "dochub_document_backups_total",
